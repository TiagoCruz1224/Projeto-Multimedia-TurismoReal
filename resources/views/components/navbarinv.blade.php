...
<nav id="header" class="fixed w-full z-30 top-0 text-white">
    <div class="w-full container mx-auto flex flex-wrap text-center mt-0 py-2">
        <div class="pl-6 flex">
            <a class="toggleColour text-black no-underline hover:no-underline font-bold text-2xl lg:text-2xl"
                href="{{ url('/') }}">
                <img src="{{ asset('images/asset_4.png') }}" alt="Logo" width="50px"></a>
            <a class="inline-block py-3 px-3 toggleColour text-white no-underline hover:no-underline font-bold text-2xl lg:text-xl"
                href="{{ url('/') }}">POLICY CENTER</a>
        </div>
